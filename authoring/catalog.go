...
func schedulerBusinessJobAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		ConfigurationRoutes: []string{"GET /metadata/definitions/scheduler/{resourceKey}", "POST /metadata/definitions/scheduler/{resourceKey}/validate", "GET /business-system/snapshot", "GET /business-references/graph", "POST /scheduler/definitions/validate", "GET /scheduler/definitions/{definitionID}"}, ResourceKeyPathParameter: "definitionID",
		...
		ReferenceContracts: []capabilitycontract.CapabilityAuthoringReference{{Kind: "scheduler_target_key", InputJSONPointer: "/target_key", ScopeFrom: "/target_type", ResolverEndpoint: "/capabilities/references/scheduler_target_key"}, {Kind: "object_key", InputJSONPointer: "/target_object", ResolverEndpoint: "/capabilities/references/object_key"}, {Kind: "role_key", InputJSONPointer: "/run_as_role", ResolverEndpoint: "/capabilities/references/role_key"}},
